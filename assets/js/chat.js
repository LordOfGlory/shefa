(function () {
  ...
  var WA = "https://wa.me/256763533786";
  ...
  function reply(q) {
    q = (q || "").toLowerCase();
    if (/human|person|agent|staff|whatsapp|call|talk/.test(q)) return "A person can help on WhatsApp +256 763 533 786. Link: " + WA;
    ...
    if (/cyber|security|pentest/.test(q)) return "Security work is authorized and defensive. See Cybersecurity or WhatsApp +256 763 533 786.";
    ...
    if (/email|mail|contact/.test(q)) return "Email shefaventurez@outlook.com or WhatsApp +256 763 533 786.";
    if (/hi|hello|hey|help/.test(q)) return "Hello. Ask about IT, security, fees, or type human.";
    return "I will hand you to a person. WhatsApp +256 763 533 786 " + WA;
  }
